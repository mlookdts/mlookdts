...
<body>
    <div class="container">
        <div class="header">
            <h1>✅ Document Received Confirmation</h1>
            <span class="badge badge-green">{{ $document->tracking_number }}</span>
        </div>

        <p>Hello,</p>
        <p>This is to confirm that your document has been received by <strong>{{ $fromUser->full_name }}</strong>.</p>
        ...
        <div class="info-row">
            ...
            <div class="info-value">{{ ucfirst(str_replace('_', ' ', $document->status)) }}</div>
        </div>
