...
@section('title', 'Create User - MLOOK')
    ...
    <div class="flex-1 lg:ml-72">
        ...
        <main class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            <div class="max-w-5xl mx-auto">
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 lg:mb-8">Create New User</h1>
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4 sm:space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        >
                            ...
                            <option value="dean" {{ old('usertype') === 'dean' ? 'selected' : '' }}>Dean</option>
                            <option value="department_head" {{ old('usertype') === 'department_head' ? 'selected' : '' }}>Department Head</option>
                    ...
                    <div id="department-field" class="hidden">
                        ...
                        >
                            ...
                            <optgroup label="Colleges">
                                @foreach($colleges as $college)
                                    <option value="{{ $college->id }}" {{ old('department_id') == $college->id ? 'selected' : '' }}>
                                        {{ $college->name }} ({{ $college->code }})
                                    </option>
                                @endforeach
                            </optgroup>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        <label for="password" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5 sm:mb-2">
                        ...
                        <input 
                            ...
                            name="password" 
                            required
                            class="w-full px-3 sm:px-4 py-2 text-sm border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition @error('password') border-red-500 @enderror"
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5 sm:mb-2">
                ...
                <div class="flex flex-col-reverse sm:flex-row items-stretch sm:items-center sm:justify-end gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button type="submit" class="btn-primary text-center min-h-[44px] flex items-center justify-center" id="createUserBtn">
                        <span id="createBtnText">Create User</span>
                        <span id="createBtnLoading" class="hidden">Creating...</span>
                    </button>
                </div>
            </form>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    showSuccessModalWithAutoClose('User Created!', '{{ session('status') }}');
