    ...
    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <div class="p-3 rounded-full {{ $user->two_factor_enabled ? 'bg-green-100 dark:bg-green-900' : 'bg-gray-100 dark:bg-gray-700' }}">
                    <svg class="w-6 h-6 {{ $user->two_factor_enabled ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if($user->two_factor_enabled)
                <button onclick="openDisable2FAModal()"
                    class="bg-red-600 hover:bg-red-700 text-white px-4 py-2.5 min-h-[44px] rounded-lg transition-colors text-sm font-medium">
                    Disable 2FA
                </button>
            @else
                <button onclick="openEnable2FAModal()"
                    class="bg-gray-900 hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 text-white px-4 py-2.5 min-h-[44px] rounded-lg transition-colors text-sm font-medium">
                    Enable 2FA
                </button>
            @endif
        </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
            ...
            @if(count($recoveryCodes) > 0)
                ...
                <button onclick="openRegenerate2FAModal()"
                    class="bg-yellow-600 hover:bg-yellow-700 text-white px-4 py-2.5 min-h-[44px] rounded-lg transition-colors text-sm font-medium">
...
<div id="disable-2fa-modal" class="fixed inset-0 bg-black/50 dark:bg-black/70 z-50 hidden items-center justify-center p-4" onclick="if(event.target === this) closeDisable2FAModal()">
    <div class="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl w-full max-w-md max-h-[90vh] flex flex-col shadow-xl" onclick="event.stopPropagation()">
        ...
        <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 py-4 flex items-center justify-between rounded-t-lg sm:rounded-t-xl flex-shrink-0">
            ...
            <button type="button" onclick="closeDisable2FAModal()" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
...
<div id="regenerate-codes-modal" class="fixed inset-0 bg-black/50 dark:bg-black/70 z-50 hidden items-center justify-center p-4" onclick="if(event.target === this) closeRegenerate2FAModal()">
    <div class="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl w-full max-w-md max-h-[90vh] flex flex-col shadow-xl" onclick="event.stopPropagation()">
        ...
        <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 py-4 flex items-center justify-between rounded-t-lg sm:rounded-t-xl flex-shrink-0">
            ...
            <button type="button" onclick="closeRegenerate2FAModal()" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                <x-icon name="x-mark" class="w-5 h-5 sm:w-6 sm:h-6" />
            </button>
        </div>
    ...
    container.innerHTML = `
        <div id="setup-2fa-modal-dynamic" class="fixed inset-0 bg-black/50 dark:bg-black/70 z-50 flex items-center justify-center p-4" onclick="if(event.target === this) closeSetup2FAModal()">
            <div class="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl w-full max-w-lg max-h-[90vh] flex flex-col shadow-xl" onclick="event.stopPropagation()">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-4 px-4 sm:px-6 pb-4 sm:pb-6 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
                    <button type="button" onclick="closeSetup2FAModal()" class="flex-1 px-4 py-2.5 min-h-[44px] text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-colors">
                        Cancel
                    </button>
                    <button type="button" onclick="showVerifyCodeModal()" class="flex-1 px-4 py-2.5 min-h-[44px] text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg transition-colors">
                        Next
                    </button>
                </div>
            </div>
        ...
        <div id="setup-2fa-modal-dynamic" class="fixed inset-0 bg-black/50 dark:bg-black/70 z-50 flex items-center justify-center p-4" onclick="if(event.target === this) closeSetup2FAModal()">
            <div class="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl w-full max-w-lg max-h-[90vh] flex flex-col shadow-xl" onclick="event.stopPropagation()">
                ...
                <div class="flex gap-3 pt-4 px-4 sm:px-6 pb-4 sm:pb-6 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
                    <button type="button" onclick="window.location.reload()" class="w-full px-4 py-2 text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg transition-colors">
                        Done
                    </button>
                </div>
            </div>
