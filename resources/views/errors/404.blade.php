...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4">
    <div class="max-w-md w-full text-center">
        <div class="mb-6 sm:mb-8">
            <h1 class="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold text-gray-200 dark:text-gray-700">404</h1>
            <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900 dark:text-white mt-4">Page Not Found</h2>
